...
colorAsteroid = [(randint(0,255),randint(0,255),randint(0,255)),(randint(0,255),randint(0,255),randint(0,255)),(randint(0,255),randint(0,255),randint(0,255))]

asteroids = [
    Asteroid(randint(10,590), randint(10, 390), size[i%3], randint(1,2), randint(1,2), colorAsteroid[i%3]) for i in range(n_asteroids)
]
