...
imagem = pygame.image.load("/home/igor/projects/jogosdigitais/papa-bolinha/img/imagem_fundo.png") 
...
while True:
    ...
    if (posicaoPapaBolinhas[1] + 20 >= Y_vermelho - 10  and posicaoPapaBolinhas[1] - 20 <= Y_vermelho + 10) and (posicaoPapaBolinhas[0] +20  >= X_vermelho - 10 and posicaoPapaBolinhas[0] - 20 <= X_vermelho + 20): 
        criar = True
        placar = placar+1
        pygame.mixer.music.load("/home/igor/projects/jogosdigitais/papa-bolinha/som/catch.mp3")
...
screen.blit(textofinal, ((800 - size[0]//2), (600 - size[1]//2)))
